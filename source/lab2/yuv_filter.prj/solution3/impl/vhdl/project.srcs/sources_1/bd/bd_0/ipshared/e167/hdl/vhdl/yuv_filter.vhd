...
architecture behav of yuv_filter is 
    ...
    "yuv_filter,hls_ip_2020_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=11.004000,HLS_SYN_LAT=784413,HLS_SYN_TPT=784408,HLS_SYN_MEM=0,HLS_SYN_DSP=11,HLS_SYN_FF=873,HLS_SYN_LUT=1921,HLS_VERSION=2020_1}";
...
begin
    ...
    Y_scale_c_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    U_scale_c_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    V_scale_c_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_done <= yuv2rgb_U0_ap_done;
    ap_idle <= (yuv_scale_U0_ap_idle and yuv2rgb_U0_ap_idle and rgb2yuv11_U0_ap_idle);
    ap_ready <= rgb2yuv11_U0_ap_ready;
