...
yuv_filter::yuv_filter(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    rgb2yuv11_U0->start_full_n(start_for_yuv_scale_U0_full_n);
    ...
    yuv_scale_U0->start_full_n(start_for_yuv2rgb_U0_full_n);
    ...
    yuv_scale_U0->Y_scale_dout(Y_scale_c_dout);
    yuv_scale_U0->Y_scale_empty_n(Y_scale_c_empty_n);
    yuv_scale_U0->Y_scale_read(yuv_scale_U0_Y_scale_read);
    yuv_scale_U0->U_scale_dout(U_scale_c_dout);
    yuv_scale_U0->U_scale_empty_n(U_scale_c_empty_n);
    yuv_scale_U0->U_scale_read(yuv_scale_U0_U_scale_read);
    yuv_scale_U0->V_scale_dout(V_scale_c_dout);
    yuv_scale_U0->V_scale_empty_n(V_scale_c_empty_n);
    ...
    Y_scale_c_U = new fifo_w8_d2_A("Y_scale_c_U");
    Y_scale_c_U->clk(ap_clk);
    Y_scale_c_U->reset(ap_rst);
    Y_scale_c_U->if_read_ce(ap_var_for_const0);
    Y_scale_c_U->if_write_ce(ap_var_for_const0);
    Y_scale_c_U->if_din(rgb2yuv11_U0_Y_scale_out_din);
    Y_scale_c_U->if_full_n(Y_scale_c_full_n);
    Y_scale_c_U->if_write(rgb2yuv11_U0_Y_scale_out_write);
    Y_scale_c_U->if_dout(Y_scale_c_dout);
    Y_scale_c_U->if_empty_n(Y_scale_c_empty_n);
    Y_scale_c_U->if_read(yuv_scale_U0_Y_scale_read);
    U_scale_c_U = new fifo_w8_d2_A("U_scale_c_U");
    U_scale_c_U->clk(ap_clk);
    U_scale_c_U->reset(ap_rst);
    U_scale_c_U->if_read_ce(ap_var_for_const0);
    U_scale_c_U->if_write_ce(ap_var_for_const0);
    U_scale_c_U->if_din(rgb2yuv11_U0_U_scale_out_din);
    U_scale_c_U->if_full_n(U_scale_c_full_n);
    U_scale_c_U->if_write(rgb2yuv11_U0_U_scale_out_write);
    U_scale_c_U->if_dout(U_scale_c_dout);
    U_scale_c_U->if_empty_n(U_scale_c_empty_n);
    U_scale_c_U->if_read(yuv_scale_U0_U_scale_read);
    V_scale_c_U = new fifo_w8_d2_A("V_scale_c_U");
    V_scale_c_U->clk(ap_clk);
    V_scale_c_U->reset(ap_rst);
    V_scale_c_U->if_read_ce(ap_var_for_const0);
    V_scale_c_U->if_write_ce(ap_var_for_const0);
    V_scale_c_U->if_din(rgb2yuv11_U0_V_scale_out_din);
    V_scale_c_U->if_full_n(V_scale_c_full_n);
    V_scale_c_U->if_write(rgb2yuv11_U0_V_scale_out_write);
    V_scale_c_U->if_dout(V_scale_c_dout);
    V_scale_c_U->if_empty_n(V_scale_c_empty_n);
    V_scale_c_U->if_read(yuv_scale_U0_V_scale_read);
    ...
    sc_trace(mVcdFile, Y_scale_c_full_n, "Y_scale_c_full_n");
    sc_trace(mVcdFile, Y_scale_c_dout, "Y_scale_c_dout");
    sc_trace(mVcdFile, Y_scale_c_empty_n, "Y_scale_c_empty_n");
    sc_trace(mVcdFile, U_scale_c_full_n, "U_scale_c_full_n");
    sc_trace(mVcdFile, U_scale_c_dout, "U_scale_c_dout");
    sc_trace(mVcdFile, U_scale_c_empty_n, "U_scale_c_empty_n");
    sc_trace(mVcdFile, V_scale_c_full_n, "V_scale_c_full_n");
    sc_trace(mVcdFile, V_scale_c_dout, "V_scale_c_dout");
    sc_trace(mVcdFile, V_scale_c_empty_n, "V_scale_c_empty_n");
...
void yuv_filter::thread_yuv2rgb_U0_start_full_n() {
    yuv2rgb_U0_start_full_n = ap_const_logic_1;
}
