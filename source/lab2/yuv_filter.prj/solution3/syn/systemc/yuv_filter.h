...
struct yuv_filter : public sc_module {
    ...
    sc_signal< sc_logic > Y_scale_c_full_n;
    sc_signal< sc_lv<8> > Y_scale_c_dout;
    sc_signal< sc_logic > Y_scale_c_empty_n;
    sc_signal< sc_logic > U_scale_c_full_n;
    sc_signal< sc_lv<8> > U_scale_c_dout;
    sc_signal< sc_logic > U_scale_c_empty_n;
    sc_signal< sc_logic > V_scale_c_full_n;
    sc_signal< sc_lv<8> > V_scale_c_dout;
    sc_signal< sc_logic > V_scale_c_empty_n;
